...
public interface DemandeAchatRepository extends JpaRepository<DemandeAchat, UUID> {
    ...
    @Query("SELECT d FROM DemandeAchat d LEFT JOIN FETCH d.fournisseurSuggere LEFT JOIN FETCH d.site LEFT JOIN FETCH d.devise LEFT JOIN FETCH d.demandeur WHERE d.statutCode = :statutCode")
    ...
    @Query("SELECT d FROM DemandeAchat d LEFT JOIN FETCH d.fournisseurSuggere LEFT JOIN FETCH d.site LEFT JOIN FETCH d.devise LEFT JOIN FETCH d.demandeur LEFT JOIN FETCH d.lignes l LEFT JOIN FETCH l.article WHERE d.id = :id")
